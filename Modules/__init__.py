...
_Items_assets = {'PSScene3Band': ['analytic', 'analytic_dn', 'basic_analytic', 'basic_analytic_dn', 'basic_analytic_dn_rpc',
                 ...
                 'PSScene4Band': ['analytic', 'analytic_dn', 'analytic_sr', 'basic_analytic', 'basic_analytic_dn', 'basic_analytic_dn_nitf',
                                  ...
                                  'basic_analytic_rpc', 'basic_analytic_rpc_nitf', 'basic_analytic_xml_nitf', 'basic_udm2', 'udm2'],
                 'PSOrthoTile': ['analytic', 'analytic_5b', 'analytic_dn', 'analytic_sr', 'visual', 'udm2'],
                 'REScene': ['basic_analytic_b1', 'basic_analytic_b1_nitf', 'basic_analytic_b2', 'basic_analytic_b2_nitf',
                             'basic_analytic_b3', 'basic_analytic_b3_nitf', 'basic_analytic_b4', 'basic_analytic_b4_nitf',
                             'basic_analytic_b5', 'basic_analytic_b5_nitf', 'basic_analytic_xml_nitf',
                             'basic_analytic_sci', 'basic_analytic_rpc', 'browse'],
                 'REOrthoTile': ['analytic', 'analytic_sr', 'visual'],
                 'SkySatScene': ['basic_analytic', 'basic_analytic_dn', 'basic_analytic_dn_rpc', 'basic_analytic_rpc',
                                 'basic_analytic_udm2', 'basic_l1a_panchromatic_dn', 'basic_l1a_panchromatic_dn_rpc',
                                 'basic_panchromatic', 'basic_panchromatic_dn', 'basic_panchromatic_dn_rpc',
                                 'basic_panchromatic_rpc', 'basic_panchromatic_udm2', 'ortho_analytic', 'ortho_analytic_sr',
                                 'ortho_analytic_dn', 'ortho_analytic_udm2', 'ortho_panchromatic', 'ortho_panchromatic_dn',
                                 'ortho_panchromatic_udm2', 'ortho_pansharpened', 'ortho_pansharpened_udm2', 'ortho_visual'],
                 'SkySatCollect': ['basic_l1a_all_frames', 'ortho_analytic', 'ortho_analytic_sr', 'ortho_analytic_dn',
                                   'ortho_analytic_udm2', 'ortho_panchromatic', 'ortho_panchromatic_dn', 'ortho_panchromatic_udm2',
                                   'ortho_pansharpened', 'ortho_pansharpened_udm2', 'ortho_visual'],
                 'SkySatVideo': ['video_file', 'video_frames'],
                 'Landsat8L1G': ['analytic_b1', 'analytic_b2', 'analytic_b3', 'analytic_b4', 'analytic_b5', 'analytic_b6',
                                 'analytic_b7', 'analytic_b8', 'analytic_b9', 'analytic_b10', 'analytic_b11',
                                 'analytic_bqa', 'visual'],
                 'Sentinel2L1C': ['analytic_b1', 'analytic_b2', 'analytic_b3', 'analytic_b4', 'analytic_b5', 'analytic_b6',
